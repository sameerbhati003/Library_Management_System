<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchCopy.aspx.cs" Inherits="SearchCopy" %>
    ...
    <header>
        ...
        <div class="row">
            <table class="srcbooktable">
                ...
                <tr><td>
                    <asp:Label ID="searchlblid" runat="server" Text="Book ID"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtsrid" runat="server" ></asp:TextBox>
                    </td>
                    <td>
                        <asp:Button ID="btnsrcid" runat="server" Text="Search" 
                            CssClass="aspbtnsrcauthor" onclick="btnsrcid_Click"/>
                    </td>
                </tr>
            </table>
        </div>
